...
public sealed class BossAgentFactory
{
    public BossAgent Create(BossAgentFactoryContext context)
    {
        if (context == null)
        {
        ...
        return new BossAgent(
            ...
            context.BossCombatConfig,
            context.AutoFindPlayer,
            context.GetDamage,
            context.GetHealthRatio,
            context.HandleAttackResult,
            context.GetProjectileTint,
            context.GetProjectileHitVfx,
            context.EnableCombatDebugLogs);
    }
}

public sealed class BossAgentFactoryContext
{
    ...
    public BossCombatConfig BossCombatConfig { get; set; }
    ...
    public Func<Color> GetProjectileTint { get; set; }
    public Func<GameObject> GetProjectileHitVfx { get; set; }
